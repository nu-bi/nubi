...
- Name: editor-panel-chat-ux.spec.js >> Desktop /editor — panel icon toggles + single chat >> clicking active panel toggle collapses the sidebar
- Location: e2e/editor-panel-chat-ux.spec.js:74:3
...
- link "Back":
  - /url: /
- heading "Your data story, beautifully told" [level=2]
- paragraph: Connect any data source. Query with plain English. Ship insights in minutes.
- list:
  - listitem: Real-time analytics across all your data sources
  - listitem: Beautiful dashboards, no SQL required
  - listitem: Enterprise-grade security and compliance
