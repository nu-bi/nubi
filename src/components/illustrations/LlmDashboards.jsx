    ...
    >
      <defs>
        ...
        <clipPath id="llm-clip">
          <rect x="26" y="64" width="436" height="194" rx="16" />
        </clipPath>
      </defs>
      ...
      <g clipPath="url(#llm-clip)">
        ...
        <rect x="68" y="139" width="74" height="7" rx="3.5" fill="#b2c4e0" />
        <rect x="54" y="158" width="88" height="7" rx="3.5" fill="#c8d5e9" />
        <rect x="54" y="172" width="56" height="7" rx="3.5" fill="#d3dded" />
        ...
        <rect x="316" y="78" width="132" height="166" rx="13"
          fill="#2456a6" fillOpacity="0.05" stroke="url(#llm-stroke)" strokeWidth="2" />
        <line x1="316" y1="102" x2="448" y2="102" stroke="#a7bbdb" strokeWidth="1.5" />
        <circle cx="330" cy="90" r="3" fill="#9cb3d7" />
        <circle cx="342" cy="90" r="3" fill="#17b3a3" fillOpacity="0.55" />

        {/* chart panel */}
        <rect x="328" y="112" width="108" height="62" rx="8"
          fill="#2456a6" fillOpacity="0.04" stroke="#c2d0e6" strokeWidth="1.25" />
        ...
        <rect x="397" y="192" width="22" height="6" rx="3" fill="#b2c4e0" />
      </g>
    </svg>
  )
}
