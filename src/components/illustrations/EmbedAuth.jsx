  ...
  return (
    ...
    >
      ...
      <g clipPath="url(#emb-clip)">
        ...
        <line x1="74" y1="180" x2="96" y2="180" stroke="#2456a6" strokeWidth="2" strokeOpacity="0.4" strokeLinecap="round" />
        <rect x="40" y="162" width="34" height="36" rx="8" fill="#2456a6" fillOpacity="0.06" stroke="url(#emb-stroke)" strokeWidth="1.75" />
        <path d="M 53 172 L 49 180 L 53 188 M 61 172 L 65 180 L 61 188" stroke="#2456a6" strokeWidth="2" strokeOpacity="0.6" strokeLinecap="round" strokeLinejoin="round" fill="none" />
        <rect x="98" y="170" width="20" height="20" rx="5" fill="#2456a6" fillOpacity="0.45" />
        ...
        <line x1="240" y1="90" x2="456" y2="90" stroke="#2456a6" strokeWidth="1.5" strokeOpacity="0.4" />
        <circle cx="254" cy="77" r="3" fill="#2456a6" fillOpacity="0.45" />
        <circle cx="266" cy="77" r="3" fill="#17b3a3" fillOpacity="0.55" />

        {/* chart panel */}
        <rect x="250" y="100" width="124" height="92" rx="9" fill="#2456a6" fillOpacity="0.04" stroke="#2456a6" strokeWidth="1.25" strokeOpacity="0.28" />
        ...
        {/* donut panel */}
        <rect x="380" y="100" width="66" height="92" rx="9" fill="#2456a6" fillOpacity="0.04" stroke="#2456a6" strokeWidth="1.25" strokeOpacity="0.28" />
        ...
        {/* table panel */}
        <rect x="250" y="200" width="196" height="86" rx="9" fill="#2456a6" fillOpacity="0.04" stroke="#2456a6" strokeWidth="1.25" strokeOpacity="0.28" />
        {[262, 330, 390].map((x, i) => (
          <rect key={i} x={x} y="212" width={i === 0 ? 48 : 36} height="6" rx="3" fill="#2456a6" fillOpacity="0.4" />
        ))}
        <line x1="250" y1="226" x2="446" y2="226" stroke="#2456a6" strokeWidth="1" strokeOpacity="0.18" />
        {[0, 1, 2].map((r) => {
          const y = 240 + r * 15
          return (
            <g key={r}>
              <circle cx="270" cy={y} r="3.5" fill={['#2456a6', '#17b3a3', '#2dd4bf'][r]} />
              <rect x="282" y={y - 3} width="40" height="6" rx="3" fill="#2456a6" fillOpacity="0.3" />
              <rect x="330" y={y - 3} width="40" height="6" rx="3" fill="#2456a6" fillOpacity="0.2" />
