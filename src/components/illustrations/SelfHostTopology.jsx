  ...
  return (
    ...
    >
      ...
      <g clipPath="url(#sht-clip)">
        ...
        <circle cx="182" cy="64" r="3.5" fill="#2456a6" fillOpacity="0.55" />
        <circle cx="194" cy="64" r="3.5" fill="#17b3a3" />
        <circle cx="206" cy="64" r="3.5" fill="#2dd4bf" />
        <line x1="180" y1="82" x2="262" y2="82" stroke="#2456a6" strokeWidth="2" strokeOpacity="0.3" strokeLinecap="round" />
        <line x1="180" y1="96" x2="232" y2="96" stroke="#2456a6" strokeWidth="2" strokeOpacity="0.3" strokeLinecap="round" />

        {/* browser → app */}
        <path d="M 240 112 L 240 142" stroke="#2456a6" strokeWidth="2" strokeOpacity="0.45" strokeLinecap="round" />
        ...
        <rect x="250" y="160" width="64" height="40" rx="9"
          fill="#2456a6" fillOpacity="0.07" stroke="#2456a6" strokeWidth="1.75" strokeOpacity="0.7" />
        <circle cx="266" cy="180" r="4" fill="#2456a6" fillOpacity="0.75" />
        <line x1="276" y1="180" x2="300" y2="180" stroke="#2456a6" strokeWidth="2" strokeOpacity="0.4" strokeLinecap="round" />
        {/* web → api link */}
        <line x1="230" y1="180" x2="250" y2="180" stroke="url(#sht-app)" strokeWidth="2" strokeLinecap="round" />

        {/* app → storage branches */}
        <path d="M 196 218 C 196 248, 148 240, 148 266" stroke="#2456a6" strokeWidth="2" strokeOpacity="0.45" strokeLinecap="round" fill="none" />
        <path d="M 284 218 C 284 248, 332 240, 332 266" stroke="#2456a6" strokeWidth="2" strokeOpacity="0.45" strokeLinecap="round" fill="none" />
        ...
        <path d="M 96 274 C 96 283, 200 283, 200 274"
          stroke="#2456a6" strokeWidth="1.75" strokeOpacity="0.5" fill="none" />
        ...
        <rect x="296" y="291" width="64" height="9" rx="4.5" fill="#2456a6" fillOpacity="0.35" />
