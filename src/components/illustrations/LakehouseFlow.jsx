    ...
    >
      <defs>
        ...
        <clipPath id="lkh-clip">
          <rect x="30" y="98" width="420" height="164" rx="16" />
        </clipPath>
      </defs>
      ...
      <g clipPath="url(#lkh-clip)">
        ...
        {/* query → engine */}
        <path d="M 144 180 L 192 180" stroke="#9cb3d7" strokeWidth="2" strokeLinecap="round" />
        ...
        <line x1="216" y1="164" x2="256" y2="164" stroke="#a7bbdb" strokeWidth="2" strokeLinecap="round" />
        <line x1="216" y1="180" x2="248" y2="180" stroke="#17b3a3" strokeWidth="2" strokeOpacity="0.7" strokeLinecap="round" />
        <line x1="216" y1="196" x2="256" y2="196" stroke="#a7bbdb" strokeWidth="2" strokeLinecap="round" />

        {/* engine → storage */}
        <path d="M 276 180 L 324 180" stroke="#9cb3d7" strokeWidth="2" strokeLinecap="round" />
        ...
        <g>
          <rect x="344" y="138" width="72" height="24" rx="7"
            fill="#2456a6" fillOpacity="0.07" stroke="#87a2ce" strokeWidth="1.75" />
          <line x1="356" y1="144" x2="356" y2="156" stroke="#a7bbdb" strokeWidth="2.5" strokeLinecap="round" />
          <line x1="368" y1="144" x2="368" y2="156" stroke="#17b3a3" strokeWidth="2.5" strokeOpacity="0.6" strokeLinecap="round" />
          <line x1="380" y1="144" x2="380" y2="156" stroke="#a7bbdb" strokeWidth="2.5" strokeLinecap="round" />
        </g>
        <g>
          ...
          <line x1="368" y1="176" x2="368" y2="188" stroke="#a7bbdb" strokeWidth="2.5" strokeLinecap="round" />
        ...
        <g>
          <rect x="344" y="202" width="72" height="24" rx="7"
            fill="#2456a6" fillOpacity="0.07" stroke="#87a2ce" strokeWidth="1.75" />
          <line x1="356" y1="208" x2="356" y2="220" stroke="#a7bbdb" strokeWidth="2.5" strokeLinecap="round" />
